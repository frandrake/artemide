...
_Started 2026-05-13 20:20 UTC_
...
User is viewing file: PartnerDetail.html
...
Design the quarterly planning page for Artemide. This page shows the year as four quarters, each with a value-exchange topic and a list of suggested partner contacts. The current quarter expands into the active planning view; the other three show topic status only.

Use the year 2026 with Q2 as the current quarter (we're in May).

Layout:

Top sticky header (FF monogram, nav with "Plan" active, search, sign-out).

Below the header, the page title section:
- Page title: "Plan" in Crimson Pro Bold 36px Slate Blue.
- Year selector to the right of the title: a small inline dropdown showing "2026" with previous and next year arrows in Slate Blue.
- Sub-line: "Quarterly value-exchange calendar · 4 of 4 quarters scheduled" in Inter 14px Charcoal.

Below the title, a row of four quarter cards. The current quarter (Q2) is visually elevated and roughly 2× the height of the others.

Q1, Q3, Q4 cards (compact):
- White background, 4px radius, 1px Light Gray border, 20px padding, 280px wide (on desktop; stack at <1024px).
- Top row: quarter label in Crimson Pro Bold 24px Slate Blue ("Q1 2026"), status pill at right.
- Topic in Inter SemiBold 18px Slate Blue (or, if not set, an Inter 14px Charcoal italic "Not set" with a small "Set topic" ghost button below).
- Inter Charcoal 12px label "Dates" and small Inter Charcoal 14px value with the quarter dates ("1 Jan – 31 Mar").
- Status pill (Inter SemiBold 12px, 4px 12px padding):
  - completed: Slate Blue background, Cool White text
  - in_progress: Slate Blue at 40% opacity background, Slate Blue text
  - planned: Light Gray background, Charcoal text

Sample data:
- Q1 2026 — completed — Topic: "Year-ahead PoV on B2B information services marketing" — Dates: 1 Jan – 31 Mar
- Q3 2026 — planned — Topic: "Mid-year market-map of agentic AI in marketing operations" — Dates: 1 Jul – 30 Sep
- Q4 2026 — planned — Topic: "End-of-year retrospective: which agentic CMO predictions held" — Dates: 1 Oct – 31 Dec

Q2 card (current, expanded):
- Same styling as the compact cards but spanning 2 cards' worth of width on desktop, taller, and with a 3px Vermillion left border accent.
- Top section identical to compact cards: "Q2 2026" header, status pill ("in_progress"), topic ("Agentic CMO themes: chapter previews for the v2 manuscript launch"), dates ("1 Apr – 30 Jun").
- An "Edit topic" ghost button inline with the topic.

Below the topic, a divider (1px Light Gray), then a section heading "Suggested contacts" in Crimson Pro 20px Slate Blue with a sub-line "5 partners spaced across the remaining 7 weeks" in Inter 12px Charcoal.

A list of suggested contact rows. Each row:
- A week badge on the left: small pill with "Week of 19 May" or similar in Inter SemiBold 12px Slate Blue on Light Gray background.
- Partner name in Inter SemiBold 16px Slate Blue.
- Firm in Inter 14px Charcoal.
- A rationale snippet in Inter 14px Charcoal italic ("Last contact 95 days ago; overdue for primary tier.")
- A small "Log contact" ghost button right-aligned.

Sample suggested contacts (in calendar order):
1. Week of 19 May — Hugh Bairstow — TML Partners — "Last contact 95 days ago; overdue. Topic vehicle: digital transformation chapter preview."
2. Week of 26 May — Sarah Whitfield — Spencer Stuart — "Cold relationship. Topic vehicle: WEF Strategic Communicators warm intro brief."
3. Week of 2 June — Marcus Penrose — Heidrick & Struggles — "Cold relationship. Topic vehicle: market-mapping call request."
4. Week of 9 June — Elena Brescia — Egon Zehnder — "Last contact 89 days ago. Topic vehicle: NED track conversation."
5. Week of 16 June — Imogen Carr — TML Partners — "Last contact 34 days ago. Topic vehicle: Q2 PoV draft review."

Below the suggested contacts, a small gap section labelled "Gaps" in Inter SemiBold 14px Slate Blue with Charcoal 12px sub-line "Firms with no contactable partner this quarter":
- Russell Reynolds — "No active partner. Action: identify CMO practice partner via WEF directory."
- Korn Ferry — "No active partner. Action: target comp practice introduction."

Footer beneath everything (same as dashboard).

Output as a single React artifact using base Tailwind utilities, arbitrary value classes for brand colours. Hardcode all data. Layout must work from 375px up — on mobile, the four quarter cards stack vertically; the Q2 card retains its expanded state. Cool White page background, white card backgrounds, no gradients, no shadows. Vermillion only as accent. Use lucide-react for any icons.
...
Plan.html is ready — quarterly calendar with Q2 2026 expanded (Vermillion left accent, suggested contacts list, gaps section) and Q1/Q3/Q4 as compact cards. Header nav now links across Dashboard, Firms, and Plan.
